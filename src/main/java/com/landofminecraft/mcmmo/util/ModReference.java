...
public final class ModReference {
	...
	public static final String CLIENT_PROXY_CLASS = "com.landofminecraft.mcmmo.client.Proxy";
	public static final String SERVER_PROXY_CLASS = "com.landofminecraft.mcmmo.server.Proxy";
