...
public final class ModUtil {
	...
	public static void setRegistryNames(final Block block, final ModMaterials material, final String nameSuffix) {
		final ResourceLocation registryName = new ResourceLocation(material.getResouceLocationDomain(nameSuffix.toLowerCase(), ForgeRegistries.BLOCKS), material.getVanillaNameLowercase(nameSuffix) + "_" + nameSuffix);
	...
	public static void setRegistryNames(final Item item, final ModMaterials material, final String nameSuffix) {
		final ResourceLocation registryName = new ResourceLocation(material.getResouceLocationDomain(nameSuffix.toLowerCase(), ForgeRegistries.ITEMS), material.getVanillaNameLowercase(nameSuffix) + "_" + nameSuffix);
	...
	public static void setRegistryNames(final IForgeRegistryEntry.Impl<?> entry, final String name) {
		setRegistryNames(entry, new ResourceLocation(ModReference.MOD_ID, name));
	}
	 ...
	 */
	public static void setRegistryNames(final IForgeRegistryEntry.Impl<?> entry, final ResourceLocation registryName) {
	 ...
	 */
	public static void setRegistryNames(final IForgeRegistryEntry.Impl<?> entry, final ResourceLocation registryName, final String unlocalizedName) {
